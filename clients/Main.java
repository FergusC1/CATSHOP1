...
import advertisements.AdvertisementsModel;
import advertisements.AdvertisementsView;
...
class Main
{
  ...
  public void startAdvertisementGUI_MVC(MiddleFactory mlf )
  {
    ...
    window.getContentPane().setBackground(Color.DARK_GRAY);
    Dimension pos = PosOnScrn.getPos();
    AdvertisementsModel model = new AdvertisementsModel(mlf);
    AdvertisementsView  view  = new AdvertisementsView( window, mlf, 0, 0 );
